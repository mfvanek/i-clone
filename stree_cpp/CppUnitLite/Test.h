...
protected:
	...
	bool check (long expected, long actual, TestResult& result, const SimpleString&, long);
	bool check (const SimpleString& expected, const SimpleString& actual, TestResult& result, const SimpleString&, long);
