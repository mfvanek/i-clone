...
const int COCO_WCHAR_MAX = 65535;
const int COCO_MIN_BUFFER_LENGTH = 1024;
const int COCO_MAX_BUFFER_LENGTH = (64*COCO_MIN_BUFFER_LENGTH);
const int COCO_HEAP_BLOCK_SIZE = (64*1024);
const wchar_t COCO_CPP_NAMESPACE_SEPARATOR = L':';
...
namespace Coco
{
   ...
   public:
      StartStates()
      {
         tab = new Elem*[128]; memset(tab, 0, 128 * sizeof(Elem*));
      }
